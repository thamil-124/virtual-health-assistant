...
<body>
<form  action="patient"  method="post" style="width:50%; margin-left:15%;margin-top:2%;margin-bottom:2%;margin-right:15%;background-color:white;"  style="border:1px solid #ccc">
  <div class="container">
    <h1>Sign Up</h1>
...
<datalist  id="clicl">    
  ...
  <option value="Others"/>
    ...
    <div class="clearfix">
      ...
      <button type="submit" class="signupbtn" value="patient">signup</button>
    </div>
  </div>
</form>
</body>
